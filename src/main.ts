...
const taskCounter = document.getElementById("taskCounter") as HTMLDivElement;
...
const filterActiveBtn = document.getElementById(
  "filterActive"
) as HTMLButtonElement;
...
function loadTasks() {
  ...
  if (savedTasks) {
    tasks = JSON.parse(savedTasks).map((task: any) => ({
      ...task,
